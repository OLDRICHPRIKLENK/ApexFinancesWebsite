      ...
      <main className="max-w-5xl mx-auto px-6 pt-20 pb-16 relative z-10">
        <div className="text-center flex flex-col items-center">
          ...
          <section id="download" className="w-full glassmorphism rounded-xl p-8 md:p-12 text-center mb-24 border border-border-subtle relative overflow-hidden">
            ...
            {/* Development Notice & GitHub Releases Link */}
            <div className="mt-8 pt-6 border-t border-border-subtle/40 flex flex-col items-center gap-3">
              <p className="text-text-secondary text-xs md:text-sm">
                Installers are in development. For beta release, please check compiled releases here. Install from terminal.
              </p>
              <a
                href="https://github.com/OLDRICHPRIKLENK/DataOntologies/releases"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2 rounded border border-border-subtle bg-charcoal/50 hover:bg-charcoal text-text-primary text-xs font-semibold tracking-tight transition-all duration-200 hover:border-indigo/50"
              >
                {/* GitHub SVG Icon */}
